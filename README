...
running at 16 MHz, it features 2 CV/gate channels and 6 gate only channels for controlling percussion.
...
* Upload the schematics and PCB layout once they're fully verified and tested
